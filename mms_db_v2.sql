...
-- Generation Time: Sep 04, 2026 at 03:45 AM
...
CREATE TABLE `tblarticle` (
  ...
  `entry_start` varchar(20) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '0',
  `entry_end` varchar(20) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '0',
  `editing_start` varchar(20) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '0',
  `editing_end` varchar(20) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '0',
  ...
  `gov_offices` varchar(150) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `remarks` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `slant` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `type` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `medium` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `station` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  ...
  `alert` enum('Yes','No') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'No',
  `status` enum('draft','submitted','editing','completed','archived') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'draft',
  `locked_by` int UNSIGNED DEFAULT NULL,
  `locked_at` datetime DEFAULT NULL,
  `created_by` int NOT NULL,
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  `archived_at` varchar(20) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '0',
...
('PMU-1787815328941', '2026-08-27', '<p>dasdasdasd</p>', '946656000', '946656000', '1788419563', '946656000', 'dasdasdasd', 'Agrarian Reform', '[\"Abu Sayyaf Group (ASG)\",\"Academic Freedom, Policies\"]', '[\"Bangko Sentral ng Pilipinas\",\"BPI\"]', 'dsadsad', '+', 'Commentary', 'Online', 'Abante Tonite', '24 Oras', '[\"Atom Araullo\",\"Sample Reporter 1\"]', 'No', 'editing', NULL, NULL, 2, '2026-08-27 07:22:08', '2026-09-03 15:12:51', '946656000', NULL),
('PMU-1788418603518', '2026-09-03', '<p>Try News</p>', '1788389803', '1788389803', '946656000', '1788390136', 'Try News', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'No', 'archived', NULL, NULL, 10, '2026-09-03 06:56:43', '2026-09-03 07:02:17', '1788390136', 9),
('PMU-1788418765816', '2026-09-03', '<p>axs</p>', '1788389965', '1788389965', '946656000', '946656000', 'axs', '', '', '', '', '', '', '', '', '', '', 'No', 'editing', NULL, NULL, 10, '2026-09-03 06:59:25', '2026-09-03 07:39:11', '946656000', NULL),
('PMU-1788428561400', '2026-09-03', '<p>abc</p>', '1788399761', '1788399761', '1788418762', '946656000', 'abc', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'No', 'editing', 9, '2026-09-03 14:59:22', 10, '2026-09-03 09:42:41', '2026-09-03 14:59:22', '946656000', NULL),
('PMU-1788445440984', '2026-09-03', '<p>e</p>', '1788416640', '1788416640', '946656000', '946656000', 'e', 'Agriculture And Food', '[\"Debt management, Treasury\\/Retail bonds\"]', '[\"Free Department\"]', NULL, '-', 'Interview', 'Print', 'Abante Tonite', '24 Oras', '[\"Atom Araullo\"]', 'No', 'draft', NULL, NULL, 10, '2026-09-03 14:24:00', '2026-09-03 14:24:00', '946656000', NULL),
('PMU-1788448434700', '2026-09-03', '<p>trial</p>', '1788419634', '1788419634', '946656000', '946656000', 'trial', 'Agriculture And Food', '[\"Free Slot\"]', '[\"Free Department\",\"BPI\"]', NULL, NULL, 'Interview', 'Print', 'Abante Tonite', '24 Oras sa DZBB', '[\"Sample Reporter 1\"]', 'No', 'draft', NULL, NULL, 10, '2026-09-03 15:13:54', '2026-09-03 15:13:54', '946656000', NULL),
('PMU-1788449053348', '2026-09-03', '<p>try try</p>', '1788420253', '1788420253', '1788420659', '1788420668', 'try try', 'Agriculture And Food', '[\"Free Slot\"]', '[\"Bangko Sentral ng Pilipinas\"]', NULL, '+', 'Interview', 'Online', 'Abante Tonite', '24 Oras', '[\"Atom Araullo\",\"Sample Reporter 2\"]', 'No', 'archived', NULL, NULL, 10, '2026-09-03 15:24:13', '2026-09-03 15:31:10', '1788420668', 9),
('PMU-1788451168762', '2026-09-03', '<p>Trial 1</p>', '1788422342', '1788422368', '946656000', '946656000', 'Trial 1', 'Agrarian Reform', '[\"Debt management, Treasury\\/Retail bonds\"]', '[\"Free Department\"]', NULL, NULL, 'Interview', 'Print', 'ABS - CBN', '24 Oras', '[\"Sample Reporter 1\"]', 'Yes', 'draft', NULL, NULL, 10, '2026-09-03 15:59:28', '2026-09-03 15:59:28', '946656000', NULL),
('PMU-1788452546627', '2026-09-03', '<p>Trial 2</p>', '1788423720', '1788423746', '1788477909', '946656000', 'Trial 2', 'Business and Economy', '[\"Debt management, Treasury\\/Retail bonds\"]', '[\"Bangko Sentral ng Pilipinas\"]', NULL, NULL, 'Interview', 'Print', 'ABS - CBN', '24 Oras', '[\"Sample Reporter 2\"]', 'No', 'editing', NULL, NULL, 10, '2026-09-03 16:22:26', '2026-09-03 23:25:14', '946656000', NULL),
('PMU-1788482612859', '2026-09-04', '<p>Trial 3 aa</p>', '1788482075', '1788482612', '1788482645', '1788482665', 'Trial 3 aa', 'Arts, Culture, History, and Entertainment', 'Debt management, Treasury/Retail bonds', 'Free Department', '', '', 'Interview', 'Print', 'Abante Tonite', '24 Oras sa DZBB', 'Atom Araullo', 'No', 'archived', NULL, NULL, 10, '2026-09-04 00:43:32', '2026-09-04 00:44:26', '1788482665', 9),
('PMU-1788484944298', '2026-09-04', '<p>Trial 4</p>', '1788484920', '1788484944', '1788484962', '1788484966', 'Trial 4', 'Agriculture And Food', '[\"Debt management, Treasury\\/Retail bonds\"]', '[\"Free Department\"]', NULL, '-', 'Public Opinion', 'Print', 'Abante Tonite', '24 Oras', '[\"Atom Araullo\"]', 'No', 'archived', NULL, NULL, 10, '2026-09-04 01:22:24', '2026-09-04 01:22:48', '1788484966', 9),
('PMU-1788491391750', '2026-09-04', '<p>Try 4</p>', '1788491373', '1788491391', '946656000', '946656000', 'Try 4', 'Arts, Culture, History, and Entertainment', '[\"Debt management, Treasury\\/Retail bonds\"]', '[\"Free Department\"]', NULL, '-', 'Interview', 'Print', 'Abante Tonite', '24 Oras', '[\"Atom Araullo\"]', 'No', 'draft', NULL, NULL, 10, '2026-09-04 03:09:51', '2026-09-04 03:09:51', '946656000', NULL),
('PMU-1788491942130', '2026-09-04', '<p>Trial 5</p>', '1788492638', '1788492638', '0', '0', 'Trial 5', 'Agrarian Reform', '[\"Plane crash\"]', '[\"Free Department\"]', NULL, '-', 'News', 'Radio', 'Abante Tonite', '24 Oras sa DZBB', '[\"Atom Araullo\"]', 'No', 'draft', NULL, NULL, 10, '2026-09-04 03:19:02', '2026-09-04 03:19:02', '0', NULL),
('PMU-1788492586990', '2026-09-04', '<p>Trial 6</p>', '1788492566', '1788492586', '0', '0', 'Trial 6', 'Arts, Culture, History, and Entertainment', '[\"Free Slot\"]', '[\"Free Department\"]', NULL, '-', 'News', 'Online', 'ABS - CBN', '24 Oras sa DZBB', '[\"Atom Araullo\"]', 'No', 'draft', NULL, NULL, 10, '2026-09-04 03:29:46', '2026-09-04 03:29:46', '0', NULL),
('PMU-1788492713558', '2026-09-04', '<p>Trial 7</p>', '1788492695', '1788492713', '1788492837', '1788492842', 'Trial 7', 'Agrarian Reform', '[\"Free Slot\"]', '[\"Bangko Sentral ng Pilipinas\"]', NULL, '+', 'Interview', 'Print', 'ABS - CBN', '24 Oras', '[\"Sample Reporter 1\"]', 'No', 'archived', NULL, NULL, 10, '2026-09-04 03:31:53', '2026-09-04 03:34:03', '1788492842', 9),
('PMU-1788492941377', '2026-09-04', '<p>Trial 8</p>', '1788492923', '1788492941', '1788492958', '1788492965', 'Trial 8', 'Agriculture And Food', '[\"Free Slot\"]', '[\"Free Department\"]', NULL, '+', 'News', 'Online', 'Abante', '24 Oras sa DZBB', '[\"Atom Araullo\"]', 'No', 'archived', NULL, NULL, 10, '2026-09-04 03:35:41', '2026-09-04 03:36:06', '1788492965', 9),
('PMU-TEST001', '2026-09-03', '<p>Test article by writer</p>', '1788428306', '1788428306', '1788491342', '1788428306', 'Test article by writer', '', '', '', '', '', '', '', '', '', '', 'No', 'editing', NULL, NULL, 7, '2026-09-03 17:38:26', '2026-09-04 03:09:06', '946656000', NULL);
...
CREATE TABLE `tblarticle_archive` (
  `id` bigint UNSIGNED NOT NULL,
  `article_id` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `archived_by` int UNSIGNED NOT NULL,
  `archived_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `archive_remarks` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
...
CREATE TABLE `tblmedium` (
  ...
  `medium_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `tblslant` (
  ...
  `slant_name` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `tblstation` (
  ...
  `station_from` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `tblusers` (
  ...
  `role` enum('ADMIN','EDITOR','WRITER') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
(7, 'Venice', 'User', 'venice', '$2y$12$wIBDEYuAWvR8U13IeoAjDuSKXqhSElTUbLzUGjJ7F3WZbz1WN/1Q2', 'ADMIN', 'ACTIVE'),
(8, 'venice', 'don', 'venicea', '$2y$12$N9hMEMxjYlt.33yww1qVNeqSQpF2gm8aZbV.Bdo1qp2u8kedoVCy.', 'ADMIN', 'ACTIVE'),
(9, 'venice', 'don', 'venicee', '$2y$12$rw4jXOKJP9nR0cBGOyBboeLqwmnb1RZIuu.25Ow4vaSx3wTfdQWe.', 'EDITOR', 'ACTIVE'),
(10, 'venice', 'don', 'venicew', '$2y$12$2Sm.2Hd16.3uYGwR2HOuZesU4pmSHXahx0idv/.0Xd9KM4FxHhgFm', 'WRITER', 'ACTIVE'),
(11, 'Venice', 'Writer', 'venicewriter', '$2y$12$OqovAcL4OjPWQSur.HUCCuYtVNbbS3DAsgKs/9YtuyLrecjphPA3C', 'WRITER', 'ACTIVE');
